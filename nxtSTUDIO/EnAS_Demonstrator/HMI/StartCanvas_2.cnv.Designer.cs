...
this.currentUser1 = new NxtControl.GuiFramework.CurrentUser();
      ...
      this.canvasTopologySeparator2.Bounds = new NxtControl.Drawing.RectF(((float)(924)), ((float)(0)), ((float)(2)), ((float)(80)));
    ...
    this.siblingsPanel.Bounds = new NxtControl.Drawing.RectF(((float)(199)), ((float)(0)), ((float)(725)), ((float)(80)));
    ...
    this.childrenPanel.Bounds = new NxtControl.Drawing.RectF(((float)(199)), ((float)(39)), ((float)(725)), ((float)(80)));
    ...
    this.childrenPanel.EndInit();
      ...
      this.exit1.Bounds = new NxtControl.Drawing.RectF(((float)(984)), ((float)(0)), ((float)(40)), ((float)(40)));
      this.exit1.Text = "";
      this.exit1.Radius = 0;
      ...
      this.ResizeBehavior = NxtControl.GuiFramework.ResizeBehavior.Resize;
